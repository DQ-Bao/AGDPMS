...
-- Cửa sổ mở quay
('C3310', N'Khung cửa sổ', 1.308),
('C3326', N'Cánh cửa sổ mở ngoài (có gân)', 1.275),
('C18762', N'Cánh cửa sổ mở ngoài (không gân)', 1.010),
('C3312', N'Cánh cửa sổ mở ngoài (có gân & bo cạnh)', 1.159),
('C8092', N'Cánh cửa sổ mở ngoài (không gân & bo cạnh)', 1.064),
('C3313', N'Cánh cửa sổ mở ngoài', 0.950),
('C920', N'Cánh cửa sổ mở ngoài', 1.126),
('C910', N'Cánh cửa sổ mở ngoài', 0.876),
('C22922', N'Cánh cửa sổ mở ngoài', 1.118),
('C3202', N'Đố động cửa sổ', 1.081),
('C3203', N'Đố động cửa đi và cửa sổ', 0.825),
('C3033', N'Đố cố định trên khung', 0.891),
('C3209', N'Khung vách kính', 0.802),
('E1283', N'Khung lá sách', 0.290),
('E192', N'Lá sách', 0.317),
('B507', N'Nan dán trang trí', 0.150),
('C459', N'Thanh truyền khóa', 0.139),
('F077', N'Pano', 0.564),
('C22903', N'Đố cố định (có lỗ vít)', 0.314),
('C3300', N'Nối khung', 0.347),
('C3318', N'Nối khung', 1.088),
...
('C3246', 'Nẹp kính', 0.216), -- Nẹp kính C3246
('C3286', 'Nẹp kính', 0.223), -- Nẹp kính C3286
('C3236', 'Nẹp kính', 0.227), -- Nẹp kính C3236
('C3296', 'Nẹp kính', 0.257), -- Nẹp kính C3296
('C3295', 'Nẹp kính', 0.271), -- Nẹp kính C3295
('C1687', 'Ke góc', 3.134),
('C4137', 'Ke góc', 1.879),
('C1697', 'Ke góc', 2.436),
('C1757', 'Ke góc', 2.167),
...
('F5017', 'Cánh cửa có lỗ vít (khoá đa điểm)', 1.507),
('F522', 'Cánh cửa có lỗ vít (khoá đơn điểm)', 1.336),
('F560', 'Đố cố định trên cánh', 1.142),
('F520', 'Ốp giữa 2 cánh mở', 0.241), -- Cần kiểm tra lại mã, có thể là lỗi đánh máy trong ảnh
...
('D15414', 'Khung ngang trên', 1.459),
('D2140', 'Đố chia cửa lùa với vách kính trên', 2.164),
('D17152', 'Khung ngang dưới (ray bằng)', 1.307),
('D15942', 'Khung ngang dưới (ray lệch)', 1.561),
('D15434', 'Khung ngang dưới (ray lệch)', 1.705),
('D15437', 'Khung đứng', 1.134),
('D3215', 'Khung đứng (3 ray)', 1.257),
('D2313', 'Khung ngang trên (3 ray)', 1.258),
('D2312', 'Khung ngang dưới (3 ray)', 2.222),
('D15444', 'Cánh ngang trên', 0.985),
('D1545A', 'Cánh ngang dưới', 1.253),
('D1547A', 'Cánh đứng trơn', 1.272),
('D1546A', 'Cánh đứng móc', 1.353),
('D28144', 'Cánh ngang trên', 1.113),
('D255A', 'Cánh ngang dưới', 1.253), -- Mã 'D255A' được suy luận
('D28146', 'Cánh đứng trơn', 1.330),
('D28127', 'Cánh đứng móc', 1.203),
('D1559A', 'Khung đứng vách kính', 1.070),
('D2818', 'Đố cố định trên vách kính', 1.545),
('D1554', 'Đố cố định trên cánh', 0.696),
('D28146', 'Nẹp đối đầu cửa 4 cánh', 0.902), -- Cần kiểm tra lại mã, có thể là lỗi đánh máy trong ảnh
('D1548A', 'Ốp khung vách kính', 0.712),
...
('D1779', 'Nẹp kính', 0.110),
('D1298', 'Nẹp kính', 0.109),
('D1168', 'Nẹp kính', 0.115),
('C101', 'Nẹp kính', 0.133),
...
('D47590', 'Ray nhôm cho cửa nhựa', 0.840),
--MẶT CẮT THANH NHÔM MẶT DỰNG LỘ ĐỐ
('GK481', 'Thanh đố đứng', 2.138), -- Dòng 1, Cột 1
('GK771', 'Thanh đố đứng', 2.281), -- Dòng 1, Cột 2
('GK491', 'Thanh đố đứng', 2.424), -- Dòng 1, Cột 3
('GK891', 'Thanh đố đứng', 2.587), -- Dòng 1, Cột 4
('GK501', 'Thanh đố đứng', 2.711), -- Dòng 2, Cột 1
('E21451', 'Thanh đố đứng', 2.347), -- Dòng 2, Cột 2
('GK581', 'Thanh đố đứng (kính hộp)', 2.730), -- Dòng 2, Cột 3
('GK953', 'Thanh đố ngang', 1.908), -- Dòng 2, Cột 4
('GK200', 'Thanh đố ngang', 1.983), -- Dòng 3, Cột 1
('GK201', 'Thanh nêm đố ngang', 0.204), -- Dòng 3, Cột 2
('GK958', 'Pat liên kết thang ngang', 1.219), -- Dòng 3, Cột 3
('GK100', 'Nắp đậy đố ngang', 0.222), -- Dòng 3, Cột 4
('GK015', 'Đế ốp mặt ngoài', 0.577), -- Dòng 4, Cột 1
('GK066', 'Nắp đậy đế ốp', 0.404), -- Dòng 4, Cột 2
('GK780', 'Nối góc 90 độ ngoài', 0.743), -- Dòng 4, Cột 3
('GK1495', 'Đế ốp mặt ngoài góc 90 độ', 1.110), -- Dòng 4, Cột 4
('GK906', 'Nắp đậy đế ốp góc 90 độ', 1.721), -- Dòng 5, Cột 1
('GK1030', 'Đế ốp mặt ngoài góc 135 độ', 0.743), -- Dòng 5, Cột 2
('GK906', 'Nắp đậy đế ốp góc 135 độ', 0.970), -- Dòng 5, Cột 3
('GK294', 'Nắp đậy khe rãnh', 0.138),
...
('GK505', 'Thanh đố kính cho cánh cửa sổ', 0.969),
('GK1215', 'Ke cửa sổ', 0.969),
--THANH NHÔM MẶT DỰNG GIẤU ĐỐ
('GK001', 'Thanh đố đứng', 1.553),
('GK011', 'Thanh đố đứng', 2.211),
('GK021', 'Thanh đố đứng', 2.203),
('GK251', 'Thanh đố đứng', 2.158),
('GK261', 'Thanh đố đứng', 3.051),
('GK813', 'Thanh đố ngang', 1.753),
('GK853', 'Thanh đố ngang', 1.757),
('GK413', 'Nắp đậy thanh đố ngang', 0.217),
('GK1745', 'Pat liên kết thanh đố ngang', 1.173),
('GK2457', 'Thanh nêm đố ngang', 0.304),
('GK228', 'Nẹp kính trái', 0.306),
('GK238', 'Nẹp kính phải', 0.294),
('GK218', 'Nẹp kính trên', 0.437),
('GK205', 'Nẹp kính dưới', 0.383),
('GK255', 'Thanh móc treo kính', 0.439),
('C459', 'Thanh truyền khóa', 0.139),
('GK275', 'Thanh đố kính', 0.245),
('GK1004', 'Chống nhấc cánh', 0.297),
('GK1255', 'Khung trên cửa sổ (dạng móc treo)', 0.918),
('GK1325', 'Cánh trên cửa sổ (dạng móc treo)', 0.791),
('GK1295', 'Khung cửa sổ', 0.751),
('GK1365', 'Cánh cửa sổ', 0.801),
('GK534', 'Thanh đố kính cho cánh cửa sổ', 0.195),
